...
void main() {
  group('viewModel Tests', () {
    ...
    test(
     ...
     test('Given corner win condition function, When correctly initialized and outer corners are selected, Then corner win detected correctly and identifies a win', () {
      viewModel.toggleCellSelection(0, 0);
    ...
    test('Given corner win condition function, When correctly initialized and inner square are selected, Then identifies a win', () {
      viewModel = TableViewModel();
    ...
    test('Given X win condition function, When initialized and satisfy condition, Then identifies a win', () {
      viewModel.toggleCellSelection(0, 0);
      viewModel.toggleCellSelection(1, 1);
      viewModel.toggleCellSelection(3, 3);
      viewModel.toggleCellSelection(4, 4);
     ...
     test('Given X win condition function, when initialized and does not satisfy condition, Then identifies a non-win scenario', () {
      viewModel.toggleCellSelection(0, 0);
      viewModel.toggleCellSelection(1, 2);
      viewModel.toggleCellSelection(2, 2);
      viewModel.toggleCellSelection(3, 3);
    ...
    test('Given horizontal win condition function, When initialized correctly and satisfy condition, Then identifies a win!', () {
      viewModel.toggleCellSelection(0, 0);
      viewModel.toggleCellSelection(1, 0);
      viewModel.toggleCellSelection(2, 0);
      viewModel.toggleCellSelection(3, 0);
    ...
    test('Given Horizontal win condition function, When initialized and does not satisfy condition, Then identifies a non-win scenario', () {
      viewModel.toggleCellSelection(0, 0);
      viewModel.toggleCellSelection(2, 2);
      viewModel.toggleCellSelection(4, 4);
    ...
    test('Given vertical win condition function, When initialized correctly and satisfy condition, Then identifies a win!', () {
      viewModel.toggleCellSelection(0, 0);
      viewModel.toggleCellSelection(0, 1);
      viewModel.toggleCellSelection(0, 2);
      viewModel.toggleCellSelection(0, 3);
    ...
    test('Given vertical win condition function, When initialized correctly and does not satisfy condition, Then identifies a non-win scenario', () {
      viewModel.toggleCellSelection(0, 1);
      viewModel.toggleCellSelection(0, 2);
      viewModel.toggleCellSelection(0, 4);
     ...
     test('Given Reset win dialog shown function, when initialized, Then set it to false and notify listeners', () {
